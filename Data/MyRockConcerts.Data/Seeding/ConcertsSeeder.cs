    ...
    public class ConcertsSeeder : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            await dbContext.Concerts.AddAsync(new Concert
            {
                ...
                Date = DateTime.ParseExact("2020-10-24 18:00", "yyyy-MM-dd HH:mm", CultureInfo.InvariantCulture),
            ...
            await dbContext.Concerts.AddAsync(new Concert
            {
                ...
                Date = DateTime.ParseExact("2020-11-14 18:00", "yyyy-MM-dd HH:mm", CultureInfo.InvariantCulture),
