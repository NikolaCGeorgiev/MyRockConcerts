    ...
    public partial class AddInitalModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupGenres", x => new { x.GroupId, x.GenreId });
                    table.ForeignKey(
                        name: "FK_GroupGenres_Genres_GenreId",
                        column: x => x.GenreId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupGenres_Groups_GroupId",
                        column: x => x.GroupId,
